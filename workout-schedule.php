...
// Query to find the trainer's schedule from workout_schedule table
$sql = "
    SELECT ScheduleID, StartTime, EndTime, ClassID, TrainerID
...
<section class="banner">
    <div class="banner-content">
        <h1>Trainer's Workout Schedule</h1>

        <?php if ($result && $result->num_rows > 0): ?>
            <!-- Display the assigned workout schedule data -->
            <table>
                <thead>
                    <tr>
                        <th>ScheduleID</th>
        ...
        <?php else: ?>
            ...
            <p>You are not assigned to any workout schedule yet.</p>
        <?php endif; ?>
    </div>
</section>
</body>
